...
(function (global, factory) {
  ...
  const className_NAME_ALERT = 'alert';
  const className_NAME_FADE$6 = 'fade';
  const className_NAME_SHOW$9 = 'show';
  /**
   * ------------------------------------------------------------------------
  ...
  className Alert extends BaseComponent {
    ...
    _getRootElement(element) {
      return getElementFromSelector(element) || element.closest(`.${className_NAME_ALERT}`);
    }
    ...
    _removeElement(element) {
      element.classNameList.remove(className_NAME_SHOW$9);
      const isAnimated = element.classNameList.contains(className_NAME_FADE$6);
  ...
  className Carousel extends BaseComponent {
      ...
      if (this._indicatorsElement) {
        ...
        for (let i = 0; i < indicators.length; i++) {
          if (Number.parseInt(indicators[i].getAttribute('data-bs-slide-to'), 10) === this._getItemIndex(element)) {
            indicators[i].classNameList.add(className_NAME_ACTIVE$2);
    ...
    _slide(directionOrOrder, element) {
      ...
      if (nextElement && nextElement.classNameList.contains(className_NAME_ACTIVE$2)) {
        this._isSliding = false;
        return;
      }
      ...
      if (this._element.classNameList.contains(className_NAME_SLIDE)) {
        ...
        activeElement.classNameList.remove(className_NAME_ACTIVE$2);
        nextElement.classNameList.add(className_NAME_ACTIVE$2);
        this._isSliding = false;
        triggerSlidEvent();
      }
  ...
  className Collapse extends BaseComponent {
    ...
    toggle() {
      if (this._element.classNameList.contains(className_NAME_SHOW$8)) {
        this.hide();
      } else {
        this.show();
      }
    ...
    show() {
      if (this._isTransitioning || this._element.classNameList.contains(className_NAME_SHOW$8)) {
        return;
      }
      ...
      if (this._triggerArray.length) {
        this._triggerArray.forEach(element => {
          element.classNameList.remove(className_NAME_COLLAPSED);
      ...
      const complete = () => {
        ...
        this._element.classNameList.add(className_NAME_COLLAPSE, className_NAME_SHOW$8);
    ...
    hide() {
      ...
      this._element.classNameList.remove(className_NAME_COLLAPSE, className_NAME_SHOW$8);
      ...
      if (triggerArrayLength > 0) {
        for (let i = 0; i < triggerArrayLength; i++) {
          ...
          if (elem && !elem.classNameList.contains(className_NAME_SHOW$8)) {
            trigger.classNameList.add(className_NAME_COLLAPSED);
    ...
    _getDimension() {
      return this._element.classNameList.contains(WIDTH) ? WIDTH : HEIGHT;
    }
    ...
    _getParent() {
      ...
      SelectorEngine.find(selector, parent).forEach(element => {
        ...
        this._addAriaAndCollapsedclassName(selected, [element]);
      });
      return parent;
    }

    _addAriaAndCollapsedclassName(element, triggerArray) {
      if (!element || !triggerArray.length) {
        return;
      }

      const isOpen = element.classNameList.contains(className_NAME_SHOW$8);
  ...
  className Dropdown extends BaseComponent {
    ...
    toggle() {
      ...
      const isActive = this._element.classNameList.contains(className_NAME_SHOW$7);
    ...
    show() {
      if (isDisabled(this._element) || this._menu.classNameList.contains(className_NAME_SHOW$7)) {
        return;
      }
      ...
      this._menu.classNameList.toggle(className_NAME_SHOW$7);

      this._element.classNameList.toggle(className_NAME_SHOW$7);
    ...
    _completeHide(relatedTarget) {
      ...
      this._menu.classNameList.remove(className_NAME_SHOW$7);
    ...
    static clearMenus(event) {
      ...
      for (let i = 0, len = toggles.length; i < len; i++) {
        ...
        if (!context._element.classNameList.contains(className_NAME_SHOW$7)) {
          continue;
        }
    ...
    static dataApiKeydownHandler(event) {
      ...
      const isActive = this.classNameList.contains(className_NAME_SHOW$7);
  ...
  const className_NAME_BACKDROP = 'modal-backdrop';
  ...
  className Backdrop {
    ...
    show(callback) {
      ...
      this._getElement().classNameList.add(className_NAME_SHOW$6);
    ...
    hide(callback) {
      ...
      this._getElement().classNameList.remove(className_NAME_SHOW$6);
    ...
    _getElement() {
      if (!this._element) {
        ...
        backdrop.classNameName = className_NAME_BACKDROP;

        if (this._config.isAnimated) {
          backdrop.classNameList.add(className_NAME_FADE$5);
        }
  ...
  className Modal extends BaseComponent {
    ...
    hide(event) {
      ...
      this._element.classNameList.remove(className_NAME_SHOW$5);
    ...
    _showElement(relatedTarget) {
      ...
      this._element.classNameList.add(className_NAME_SHOW$5);
    ...
    _isAnimated() {
      return this._element.classNameList.contains(className_NAME_FADE$4);
    }
  ...
  const className_PREFIX$1 = 'bs-tooltip';
  const BSCLS_PREFIX_REGEX$1 = new RegExp(`(^|\\s)${className_PREFIX$1}\\S+`, 'g');
  ...
  className Tooltip extends BaseComponent {
    ...
    toggle(event) {
      ...
      if (event) {
        ...
        if (this.getTipElement().classNameList.contains(className_NAME_SHOW$3)) {
    ...
    dispose() {
      ...
      EventHandler.off(this._element.closest(`.${className_NAME_MODAL}`), 'hide.bs.modal', this._hideModalHandler);
    ...
    show() {
      ...
      if (this._config.animation) {
        tip.classNameList.add(className_NAME_FADE$3);
      }
      ...
      tip.classNameList.add(className_NAME_SHOW$3);
      const customclassName = typeof this._config.customclassName === 'function' ? this._config.customclassName() : this._config.customclassName;
      ...
      const isAnimated = this.tip.classNameList.contains(className_NAME_FADE$3);
    ...
    hide() {
      ...
      tip.classNameList.remove(className_NAME_SHOW$3); // If this is a touch-enabled device we remove the extra
      // empty mouseover listeners we added for iOS support
    ...
    setContent() {
      ...
      tip.classNameList.remove(className_NAME_FADE$3, className_NAME_SHOW$3);
    }
    ...
    _addAttachmentclassName(attachment) {
      this.getTipElement().classNameList.add(`${className_PREFIX$1}-${this.updateAttachment(attachment)}`);
    }
    ...
    _setListeners() {
      ...
      EventHandler.on(this._element.closest(`.${className_NAME_MODAL}`), 'hide.bs.modal', this._hideModalHandler);
    ...
    _enter(event, context) {
      ...
      if (context.getTipElement().classNameList.contains(className_NAME_SHOW$3) || context._hoverState === HOVER_STATE_SHOW) {
    ...
    _cleanTipclassName() {
      const tip = this.getTipElement();
      const tabclassName = tip.getAttribute('className').match(BSCLS_PREFIX_REGEX$1);
  ...
  const className_PREFIX = 'bs-popover';
  const BSCLS_PREFIX_REGEX = new RegExp(`(^|\\s)${className_PREFIX}\\S+`, 'g');
  ...
  className Popover extends Tooltip {
    ...
    _addAttachmentclassName(attachment) {
      this.getTipElement().classNameList.add(`${className_PREFIX}-${this.updateAttachment(attachment)}`);
    }
    ...
    _cleanTipclassName() {
      const tip = this.getTipElement();
      const tabclassName = tip.getAttribute('className').match(BSCLS_PREFIX_REGEX);
  ...
  className ScrollSpy extends BaseComponent {
    constructor(element, config) {
      ...
      this._config = this._getConfig(config);
      this._selector = `${this._config.target} ${SELECTOR_NAV_LINKS}, ${this._config.target} ${SELECTOR_LIST_ITEMS}, ${this._config.target} .${className_NAME_DROPDOWN_ITEM}`;
      this._offsets = [];
      this._targets = [];
    ...
    _activate(target) {
      ...
      if (link.classNameList.contains(className_NAME_DROPDOWN_ITEM)) {
        SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE$1, link.closest(SELECTOR_DROPDOWN$1)).classNameList.add(className_NAME_ACTIVE$1);
        link.classNameList.add(className_NAME_ACTIVE$1);
      } else {
        ...
        SelectorEngine.parents(link, SELECTOR_NAV_LIST_GROUP$1).forEach(listGroup => {
          ...
          SelectorEngine.prev(listGroup, `${SELECTOR_NAV_LINKS}, ${SELECTOR_LIST_ITEMS}`).forEach(item => item.classNameList.add(className_NAME_ACTIVE$1)); // Handle special case when .nav-link is inside .nav-item

          SelectorEngine.prev(listGroup, SELECTOR_NAV_ITEMS).forEach(navItem => {
            SelectorEngine.children(navItem, SELECTOR_NAV_LINKS).forEach(item => item.classNameList.add(className_NAME_ACTIVE$1));
          });
        });
      }
    ...
    _clear() {
      SelectorEngine.find(this._selector).filter(node => node.classNameList.contains(className_NAME_ACTIVE$1)).forEach(node => node.classNameList.remove(className_NAME_ACTIVE$1));
    } // Static
  ...
  className Tab extends BaseComponent {
    ...
    _activate(element, container, callback) {
      ...
      const isTransitioning = callback && active && active.classNameList.contains(className_NAME_FADE$1);

      const complete = () => this._transitionComplete(element, active, callback);

      if (active && isTransitioning) {
        active.classNameList.remove(className_NAME_SHOW$1);
    ...
    _transitionComplete(element, active, callback) {
      ...
      if (parent && parent.classNameList.contains(className_NAME_DROPDOWN_MENU)) {
        ...
        if (dropdownElement) {
          SelectorEngine.find(SELECTOR_DROPDOWN_TOGGLE, dropdownElement).forEach(dropdown => dropdown.classNameList.add(className_NAME_ACTIVE));
        }
